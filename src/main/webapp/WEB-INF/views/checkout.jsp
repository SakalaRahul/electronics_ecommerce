...
<head>
    ...
    <title>Secure checkout · Voltrix</title>
            ...
            <div class="container max-width-xl">
                <div class="row justify-content-center">
                    <div class="col-md-7 col-lg-5">
                        ...
                        <div class="glass-card auth-glass-card p-4 rounded-4 shadow-sm reveal">
                            <div class="eyebrow text-info mb-1">Gateway security</div>
                            <h1 class="h3 text-white fw-bold mb-2">Secure payment</h1>
                            <p class="text-white-50 mb-4 small">
                                Complete your payment securely using Razorpay.
                            </p>

                            <div class="d-flex justify-content-between align-items-center border-top border-bottom border-secondary border-opacity-50 py-3 mb-4">
                                <span class="text-white-50">Total amount</span>
                                <span class="product-price text-info fs-4 fw-bold">&#8377; ${totalPrice}</span>
                            </div>

                            <button id="rzp-button" type="button" class="btn btn-success btn-lg w-100 fw-semibold rounded-3 py-3 shadow-sm mb-2">
                                Pay securely with Razorpay <i class="bi bi-shield-lock ms-2"></i>
                            </button>

                            <a href="${ctx}/cart" class="btn btn-link text-white-50 text-decoration-none w-100 mt-2 small">
    ...
    <script>
        ...
        paymentButton.addEventListener("click", function () {
            if (typeof Razorpay === "undefined") {
                alert("Razorpay could not be loaded. Check your internet connection.");
                return;
            }
            ...
            const options = {
                ...
                handler: function (response) {
                    ...
                    form.method = "POST";
                    form.action = "${ctx}/payment/verify";
                ...
                modal: {
                    ondismiss: function () {
                        ...
                        paymentButton.innerHTML = 'Pay securely with Razorpay <i class="bi bi-shield-lock ms-2"></i>';
                    }
                },
            ...
            paymentButton.innerText = "Opening Razorpay...";
